...
package com.android.doctorAppointment.ML.env;
...
public final class Logger1 {
  ...
  static {
    ...
    IGNORED_CLASS_NAMES.add(Logger1.class.getCanonicalName());
  }
   ...
   */
  public Logger1(final Class<?> clazz) {
   ...
   */
  public Logger1(final String messagePrefix) {
   ...
   *     being used
   */
  public Logger1(final String tag, final String messagePrefix) {
    this.tag = tag;
  ...
  /** Creates a Logger using the caller's class name as the message prefix. */
  public Logger1(final int minLogLevel) {
    this(DEFAULT_TAG, null);
  ...
  private static String getCallerSimpleName() {
    ...
    return Logger1.class.getSimpleName();
  }
