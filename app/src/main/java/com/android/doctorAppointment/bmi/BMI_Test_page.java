package com.android.doctorAppointment.bmi;
...
public class BMI_Test_page extends AppCompatActivity {
    float height,weight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bmi_test_page);
    ...
    private void CalculateBMI() {
        ...
        Intent intent = new Intent(BMI_Test_page.this, ResultActivity.class);
